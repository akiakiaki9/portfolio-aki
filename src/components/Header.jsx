    ...
    <header className="header">
      <div className="header-blok">
        <div className="header-blok__section-1">
          ...
          <p className="header__body">Welcome to my page! Here you will find information about my projects, my work
            experience, and my
          ...
          <div className="header-blok-footer">
            <button className="header-blok-footer__btn-1"><Link className='header-blok-footer-link'>Hire</Link></button>
            <button className="header-blok-footer__btn-2"><Link className='header-blok-footer-link' to='/contacts'>Contact</Link></button>
          </div>
        </div>
